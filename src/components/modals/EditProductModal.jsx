...
const EditProductModal = ({ isOpen, closeModal, allProduct, setAllProduct, productToEdit }) => {


    // Create a update request to update product to database
            ...
            .then(
                (response) => {
                    ...
                    response.json().then((data) => {
                        setAllProduct(data);
                        closeModal();
                        // force update the state with key property
                        setAllProduct(allProduct.map(product => product._id === data._id ? data : product));
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <div className='flex'>
                                                <div className='w-1/2 mr-3'>
                                                    <input type="submit" value="Update" className='w-full  px-5 py-3 bg-rose-500 mt-5 text-white rounded cursor-pointer hover:bg-rose-600 transition duration-300' />
                                                </div>
